...
export const HeaderNavMenu:React.FC =()=>{ return (
  <nav aria-label="Nav menu" className="hidden md:flex justify-between items-center text-textDark gap-5 lg:gap-10">
    <NavItem>
    ...
    <NavItem>
      <Link aria-label="Link to contacts section" href="/#contacts" className="p-2">
        Contacts
      </Link>
    </NavItem>
  </nav>
